...
namespace Owis_rot_stage_with_Pilatus_console
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Insert COM port of OWIS rotation stage: ");
            String nComPort_str = Console.ReadLine();
            // ask for axis of OWIS rotation stage
            Console.WriteLine("Insert axis of OWIS rotation stage: ");
            ...
            Console.WriteLine("Insert initial position in deg: ");
            String dDistanceInitial_str = Console.ReadLine();
            // ask for final position
            Console.WriteLine("Insert final position in deg: ");
            String dDistanceFinal_str = Console.ReadLine();
            // ask for step
            Console.WriteLine("Insert step in deg: ");
            String dDistanceStep_str = Console.ReadLine();
